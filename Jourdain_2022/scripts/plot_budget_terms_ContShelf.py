...
npz_TS_file = np.load('TS_profiles_ContShelf.npz')
mean_dT = npz_TS_file['mean_Tf'] - npz_TS_file['mean_Tp']

if not os.path.isfile('budget_dT_terms_ContShelf.npz'):
  ...
  np.savez('budget_dT_terms_ContShelf.npz',mean_dT_hadv=mean_dT_hadv,\
  ...
  print('  ')
  print('WARNING !!! USING EXISTING budget_dT_terms_ContShelf.npz !!!')
  print('  Delete before running this script if you want to regenerate it.')
  print('  ')

  npzfileT = np.load('budget_dT_terms_ContShelf.npz')
...
if not os.path.isfile('budget_dS_terms_ContShelf.npz'):
  ...
  np.savez('budget_dS_terms_ContShelf.npz',mean_dS_hadv=mean_dS_hadv,\
  ...
  print('  ')
  print('WARNING !!! USING EXISTING budget_dS_terms_ContShelf.npz !!!')
  print('  Delete before running this script if you want to regenerate it.')
  print('  ')

  npzfileS = np.load('budget_dS_terms_ContShelf.npz')
...
line26, = axs[1].plot(mean_dS_qisf,ZZ,color=col[7])
...
fig.savefig('budget_terms_ContShelf.jpg')
fig.savefig('budget_terms_ContShelf.pdf')
