...
for kmod in np.arange(3):
   ...
   exec("sm245EXT_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_asmb_2015-2100_ssp245_regrid_04000m_FROM_ssp585.nc',decode_cf=False)")
   exec("sm126_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_asmb_2015-2100_ssp126_regrid_04000m.nc',decode_cf=False)")
   exec("sm126EXT_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_asmb_2015-2100_ssp126_regrid_04000m_FROM_ssp585.nc',decode_cf=False)")
   #-
   ...
   exec("me245EXT_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_ame_2015-2100_ssp245_regrid_04000m_FROM_ssp585.nc',decode_cf=False)")
   exec("me126_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_ame_2015-2100_ssp126_regrid_04000m.nc',decode_cf=False)")
   exec("me126EXT_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_ame_2015-2100_ssp126_regrid_04000m_FROM_ssp585.nc',decode_cf=False)")
   #-
   ...
   exec("ru245EXT_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_aru_2015-2100_ssp245_regrid_04000m_FROM_ssp585.nc',decode_cf=False)")
   exec("ru126_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_aru_2015-2100_ssp126_regrid_04000m.nc',decode_cf=False)")
   exec("ru126EXT_"+kmod.astype('str')+"=xr.open_dataset('MAR-'+model[kmod]+'_aru_2015-2100_ssp126_regrid_04000m_FROM_ssp585.nc',decode_cf=False)")
...
mean_2015_2100=np.mean(tmp2)
axs[0].text(2020,ymax-0.10*dy,'SSP2-4.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.5,0.5,0.5])
...
axs[0].text(2020,ymax-0.16*dy,'Emulated SSP2-4.5 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='red')
...
mean_2015_2100=np.mean(tmp2)
axs[0].text(2020,ymax-0.22*dy,'SSP1-2.6 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.8,0.8,0.8])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[0].text(2020,ymax-0.28*dy,'Emulated SSP1-2.6 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='orange')
...
dy=ymax-ymin
axs[1].text(2020,ymin+0.35*dy,'SSP5-8.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color='black')
#-
...
mean_2015_2100=np.mean(tmp2)
axs[1].text(2020,ymin+0.29*dy,'SSP2-4.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.5,0.5,0.5])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[1].text(2020,ymin+0.23*dy,'Emulated SSP2-4.5 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='red')
...
mean_2015_2100=np.mean(tmp2)
axs[1].text(2020,ymin+0.17*dy,'SSP1-2.6 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.8,0.8,0.8])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[1].text(2020,ymin+0.11*dy,'Emulated SSP1-2.6 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='orange')
...
dy=ymax-ymin
axs[2].text(2020,ymax-0.10*dy,'SSP5-8.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color='black')
#-
...
mean_2015_2100=np.mean(tmp2)
axs[2].text(2020,ymax-0.16*dy,'SSP2-4.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.5,0.5,0.5])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[2].text(2020,ymax-0.22*dy,'Emulated SSP2-4.5 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='red')
...
mean_2015_2100=np.mean(tmp2)
axs[2].text(2020,ymax-0.28*dy,'SSP1-2.6 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.8,0.8,0.8])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[2].text(2020,ymax-0.34*dy,'Emulated SSP1-2.6 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='orange')
...
dy=ymax-ymin
axs[3].text(2020,ymax-0.10*dy,'SSP5-8.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color='black')
#-
...
mean_2015_2100=np.mean(tmp2)
axs[3].text(2020,ymax-0.16*dy,'SSP2-4.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.5,0.5,0.5])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[3].text(2020,ymax-0.22*dy,'Emulated SSP2-4.5 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='red')
...
mean_2015_2100=np.mean(tmp2)
axs[3].text(2020,ymax-0.28*dy,'SSP1-2.6 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.8,0.8,0.8])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[3].text(2020,ymax-0.34*dy,'Emulated SSP1-2.6 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='orange')
...
dy=ymax-ymin
axs[4].text(2020,ymax-0.10*dy,'SSP5-8.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color='black')
#-
...
mean_2015_2100=np.mean(tmp2)
axs[4].text(2020,ymax-0.16*dy,'SSP2-4.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.5,0.5,0.5])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[4].text(2020,ymax-0.22*dy,'Emulated SSP2-4.5 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='red')
...
mean_2015_2100=np.mean(tmp2)
axs[4].text(2020,ymax-0.28*dy,'SSP1-2.6 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.8,0.8,0.8])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[4].text(2020,ymax-0.34*dy,'Emulated SSP1-2.6 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='orange')
...
dy=ymax-ymin
axs[5].text(2020,ymax-0.10*dy,'SSP5-8.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color='black')
#-
...
mean_2015_2100=np.mean(tmp2)
axs[5].text(2020,ymax-0.16*dy,'SSP2-4.5 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.5,0.5,0.5])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[5].text(2020,ymax-0.22*dy,'Emulated SSP2-4.5 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='red')
...
mean_2015_2100=np.mean(tmp2)
axs[5].text(2020,ymax-0.28*dy,'SSP1-2.6 from RCMs  (mean='+np.array2string(mean_2015_2100,precision=1)+')',fontsize=14,color=[0.8,0.8,0.8])
...
bias_2015_2100=np.mean(tmp3-tmp2)
axs[5].text(2020,ymax-0.34*dy,'Emulated SSP1-2.6 (bias='+np.array2string(bias_2015_2100,precision=1)+')',fontsize=14,color='orange')
...
figname='timeseries_sspxxx_ssp585_CESM2_UKESM_MPI_new.pdf'
