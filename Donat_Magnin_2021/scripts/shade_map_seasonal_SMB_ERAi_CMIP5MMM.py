...
smb_JAN_p=np.nansum(ncSp['smb'].values[9*12+0::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_FEB_p=np.nansum(ncSp['smb'].values[9*12+1::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_MAR_p=np.nansum(ncSp['smb'].values[9*12+2::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_APR_p=np.nansum(ncSp['smb'].values[9*12+3::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_MAY_p=np.nansum(ncSp['smb'].values[9*12+4::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_JUN_p=np.nansum(ncSp['smb'].values[9*12+5::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_JUL_p=np.nansum(ncSp['smb'].values[9*12+6::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_AUG_p=np.nansum(ncSp['smb'].values[9*12+7::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_SEP_p=np.nansum(ncSp['smb'].values[9*12+8::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_OCT_p=np.nansum(ncSp['smb'].values[9*12+9::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_NOV_p=np.nansum(ncSp['smb'].values[9*12+10::12,0,j1:j2,i1:i2],axis=0)*msk # in mm.w.e/month
smb_DEC_p=np.nansum(ncSp['smb'].values[9*12+11::12,0,j1:j2,i1:i2],axis=0)*msk # in mm.w.e/month

file_smb_futu=pref_futu+'smb'+suff_futu
ncSf=xr.open_dataset(file_smb_futu,decode_cf=False)
smb_JAN_f=np.nansum(ncSf['smb'].values[0::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_FEB_f=np.nansum(ncSf['smb'].values[1::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_MAR_f=np.nansum(ncSf['smb'].values[2::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_APR_f=np.nansum(ncSf['smb'].values[3::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_MAY_f=np.nansum(ncSf['smb'].values[4::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_JUN_f=np.nansum(ncSf['smb'].values[5::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_JUL_f=np.nansum(ncSf['smb'].values[6::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_AUG_f=np.nansum(ncSf['smb'].values[7::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_SEP_f=np.nansum(ncSf['smb'].values[8::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_OCT_f=np.nansum(ncSf['smb'].values[9::12,0,j1:j2,i1:i2],axis=0)*msk  # in mm.w.e/month
smb_NOV_f=np.nansum(ncSf['smb'].values[10::12,0,j1:j2,i1:i2],axis=0)*msk # in mm.w.e/month
smb_DEC_f=np.nansum(ncSf['smb'].values[11::12,0,j1:j2,i1:i2],axis=0)*msk # in mm.w.e/month

smb_anom_SON = smb_SEP_f + smb_OCT_f + smb_NOV_f - ( smb_SEP_p + smb_OCT_p + smb_NOV_p )  # in mm.w.e/(3 months)
smb_anom_DJF = smb_DEC_f + smb_JAN_f + smb_FEB_f - ( smb_DEC_p + smb_JAN_p + smb_FEB_p )
smb_anom_MAM = smb_MAR_f + smb_APR_f + smb_MAY_f - ( smb_MAR_p + smb_APR_p + smb_MAY_p )
smb_anom_JJA = smb_JUN_f + smb_JUL_f + smb_AUG_f - ( smb_JUN_p + smb_JUL_p + smb_AUG_p )
