...
for kmon in np.arange(np.shape(TTz)[0]):
  TTzmon_ABB[kmon]=np.nansum(np.nansum(TTz[kmon,:,:]*msk*msk_ABB*msk_isf_ABB,axis=1),axis=0)/np.nansum(np.nansum(msk*msk_ABB*msk_isf_ABB,axis=1),axis=0)
  TTzmon_COS[kmon]=np.nansum(np.nansum(TTz[kmon,:,:]*msk*msk_COS*msk_isf_COS,axis=1),axis=0)/np.nansum(np.nansum(msk*msk_COS*msk_isf_COS,axis=1),axis=0)
  TTzmon_PIG[kmon]=np.nansum(np.nansum(TTz[kmon,:,:]*msk*msk_PIG*msk_isf_PIG,axis=1),axis=0)/np.nansum(np.nansum(msk*msk_PIG*msk_isf_PIG,axis=1),axis=0)
  TTzmon_THW[kmon]=np.nansum(np.nansum(TTz[kmon,:,:]*msk*msk_THW*msk_isf_THW,axis=1),axis=0)/np.nansum(np.nansum(msk*msk_THW*msk_isf_THW,axis=1),axis=0)
  TTzmon_CRO[kmon]=np.nansum(np.nansum(TTz[kmon,:,:]*msk*msk_CRO*msk_isf_CRO,axis=1),axis=0)/np.nansum(np.nansum(msk*msk_CRO*msk_isf_CRO,axis=1),axis=0)
  TTzmon_DOT[kmon]=np.nansum(np.nansum(TTz[kmon,:,:]*msk*msk_DOT*msk_isf_DOT,axis=1),axis=0)/np.nansum(np.nansum(msk*msk_DOT*msk_isf_DOT,axis=1),axis=0)
  TTzmon_GET[kmon]=np.nansum(np.nansum(TTz[kmon,:,:]*msk*msk_GET*msk_isf_GET,axis=1),axis=0)/np.nansum(np.nansum(msk*msk_GET*msk_isf_GET,axis=1),axis=0)
