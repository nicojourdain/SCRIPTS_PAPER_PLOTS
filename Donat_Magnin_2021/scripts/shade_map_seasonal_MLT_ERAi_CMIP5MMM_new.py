...
mlt_anom_SON = np.nansum(   ( ncSf['mlt'].values[ 8::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 8::12,0,j1:j2,i1:i2] ) * 30. / 30. \
                          + ( ncSf['mlt'].values[ 9::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 9::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                          + ( ncSf['mlt'].values[10::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+10::12,0,j1:j2,i1:i2] ) * 30. / 30. , axis=0) * msk
mlt_anom_DJF = np.nansum(   ( ncSf['mlt'].values[11::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+11::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                          + ( ncSf['mlt'].values[ 0::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 0::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                          + ( ncSf['mlt'].values[ 1::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 1::12,0,j1:j2,i1:i2] ) * 28. / 30. , axis=0) * msk
mlt_anom_MAM = np.nansum(   ( ncSf['mlt'].values[ 2::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 2::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                          + ( ncSf['mlt'].values[ 3::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 3::12,0,j1:j2,i1:i2] ) * 30. / 30. \
                          + ( ncSf['mlt'].values[ 4::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 4::12,0,j1:j2,i1:i2] ) * 31. / 30. , axis=0) * msk
mlt_anom_JJA = np.nansum(   ( ncSf['mlt'].values[ 5::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 5::12,0,j1:j2,i1:i2] ) * 30. / 30. \
                          + ( ncSf['mlt'].values[ 6::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 6::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                          + ( ncSf['mlt'].values[ 7::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 7::12,0,j1:j2,i1:i2] ) * 31. / 30. , axis=0) * msk

mlt_std_SON = np.nanstd(   ( ncSf['mlt'].values[ 8::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 8::12,0,j1:j2,i1:i2] ) * 30. / 30. \
                         + ( ncSf['mlt'].values[ 9::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 9::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                         + ( ncSf['mlt'].values[10::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+10::12,0,j1:j2,i1:i2] ) * 30. / 30. , axis=0) * msk
mlt_std_DJF = np.nanstd(   ( ncSf['mlt'].values[11::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+11::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                         + ( ncSf['mlt'].values[ 0::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 0::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                         + ( ncSf['mlt'].values[ 1::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 1::12,0,j1:j2,i1:i2] ) * 28. / 30. , axis=0) * msk
mlt_std_MAM = np.nanstd(   ( ncSf['mlt'].values[ 2::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 2::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                         + ( ncSf['mlt'].values[ 3::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 3::12,0,j1:j2,i1:i2] ) * 30. / 30. \
                         + ( ncSf['mlt'].values[ 4::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 4::12,0,j1:j2,i1:i2] ) * 31. / 30. , axis=0) * msk
mlt_std_JJA = np.nanstd(   ( ncSf['mlt'].values[ 5::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 5::12,0,j1:j2,i1:i2] ) * 30. / 30. \
                         + ( ncSf['mlt'].values[ 6::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 6::12,0,j1:j2,i1:i2] ) * 31. / 30. \
                         + ( ncSf['mlt'].values[ 7::12,0,j1:j2,i1:i2] - ncSp['mlt'].values[9*12+ 7::12,0,j1:j2,i1:i2] ) * 31. / 30. , axis=0) * msk

# t-value
t_SON = mlt_anom_SON*np.sqrt(30)/mlt_std_SON
t_DJF = mlt_anom_DJF*np.sqrt(30)/mlt_std_DJF
t_MAM = mlt_anom_MAM*np.sqrt(30)/mlt_std_MAM
t_JJA = mlt_anom_JJA*np.sqrt(30)/mlt_std_JJA
...
eps = 0.1
tmp=t_SON*1.e0
t_SON[np.abs(tmp)>=tused]=1 ; t_SON[np.abs(tmp)<tused]=0 ; t_SON[mlt_std_SON<eps]=0
tmp=t_DJF*1.e0
t_DJF[np.abs(tmp)>=tused]=1 ; t_DJF[np.abs(tmp)<tused]=0 ; t_DJF[mlt_std_DJF<eps]=0
tmp=t_MAM*1.e0
t_MAM[np.abs(tmp)>=tused]=1 ; t_MAM[np.abs(tmp)<tused]=0 ; t_MAM[mlt_std_MAM<eps]=0
tmp=t_JJA*1.e0
t_JJA[np.abs(tmp)>=tused]=1 ; t_JJA[np.abs(tmp)<tused]=0 ; t_JJA[mlt_std_JJA<eps]=0
